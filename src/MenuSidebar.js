            ...
            <nav className="navbar navbar-custom navbar-fixed-top" role="navigation">
                ...
                <div className="container-fluid">
                    <div className="navbar-header">
                        <button type="button" className="navbar-toggle collapsed" data-toggle="collapse" style={queries.query} data-target="#sidebar-collapse">
                            <span className="sr-only">Toggle navigation</span>
                            <span className="icon-bar" />
                            <span className="icon-bar" />
                            <span className="icon-bar" />
                        </button>
                        <a className="navbar-brand" href="#"><span>Apa Kabar&nbsp;</span>Korona</a>
                        <ul className="nav navbar-top-links navbar-right">
                            <li className="dropdown">
                                ...
                                <ul className="dropdown-menu dropdown-messages" >
                                    <li>
                                        <div className="dropdown-messages-box" className="col-sm-12" >
                                            <a href="profile.html" className="pull-left">
                                                <img alt="image" className="img-circle" />
                                            </a>
                                            <div className="message-body">
                                                <small className="pull-right">3 mins ago</small>
                                                <a href="#"><strong>aris</strong> commented on
